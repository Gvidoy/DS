...
public class PanelBotones extends JPanel implements Observador {
	...
	synchronized void BotonEncenderActionPerformed(ActionEvent evt) {
	...
	public boolean equals(Object obj){
		...
		if(obj instanceof PanelBotones){
			PanelBotones aux = (PanelBotones) obj;
			
			if (this.monitor == null && aux.monitor == null && this.control == null && aux.control == null)
				result = true;
			if (result == false)
				if((this.interfaz.equals(aux.interfaz))
					&& (this.monitor.equals(aux.monitor))
					&& (this.control.equals(aux.control)))
							result = true;
		}
		return result;
	}
